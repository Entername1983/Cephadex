...
from wtforms import (
    DateField, IntegerField, StringField, PasswordField,
    SubmitField, RadioField, SelectField, BooleanField, TextAreaField
)
from flask_wtf.file import FileField, FileAllowed, FileSize
from wtforms_sqlalchemy.fields import QuerySelectField
from wtforms.validators import (
    InputRequired, Length, ValidationError,
    EqualTo, Optional, URL, DataRequired, Email
)
...
class DeckOrg(FlaskForm):    
    ...
    new_deck_source = StringField('deck_topic')
    ...
    new_category = SelectField('Category', choices=[('Mix', 'Mix'), ('Definitions', 'Definitions'), ('Mcq', 'Multiple choice'), ('Translate', 'Translate'), ('Cloze', 'Fill in the blank'),
                                           ...
                                           ('People', 'People'), ('Vocab_builder', 'Vocabulary builder'), ('Custom', 'Custom')], default='Mix')
