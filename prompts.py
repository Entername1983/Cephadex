prompt_choices = {
    ...
    "Formulas": 'Use the format  \ ( [LaTeX : code] \ ) for LaTeX formulas.  Given the passage below, extract all mentions of math or scientic formulas or terms, and provide the name of the formula (or term), the formula itself (or formula associated with the term) in latex format, and an explanation of the formula.  Create a JSON object which enumerates a set of child objects.  Each of the child objects should correspond to one of the formulas extracted and have a property named "A", for the name of the formula, "B" for the formula itself in latex format, and "C" for the explanation of the formula.  \n The resulting JSON object should be in this format: [{"A":"name of formula","B":"LaTeX formula","C":"explanation of formula"}] \n The passage: \n',
    } 
