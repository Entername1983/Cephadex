...
prompt_choices = {
    ...
    "Comprehension":'Given the passage below, create a series of questions to test comprehension of the key information contained within.  Create a JSON object which enumerates a set of child objects.  Each of the child objects should correspond to one of the comprehension questions and have a property named "QC" for the question, and "AC" for the answer.  \n The resulting JSON object should be in this format: [{"QC":"string","AC":"string"}] \n The passage: \n',
    } 
